    ...
    <div className="shell">
      ...
      <div className="shell-body">
        ...
        <div className="page-sub">
          Paste in HTML from an existing test (like your Day 26 file) and it'll be reformatted
          into this design, ready to solve. Saved locally in this browser — use "Export backup"
          any time to keep a copy of your data.
        </div>
